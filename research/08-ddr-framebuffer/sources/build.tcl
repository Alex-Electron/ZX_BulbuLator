# Bulbulator Step 8 - ZX 128K + AXI inject + tear-free DDR triple-buffer FB, xc7z010clg400-1.
#
...
# board glue, control plane, DDR-framebuffer chain and rom128.hex are flat in build/.
# framebuffer.v from Steps 6/7 is gone here - the DDR chain replaces it.
...
# EBAZ glue + control plane + DDR-framebuffer chain (replaces framebuffer.v) + the top.
