...
`bitstreams/ATLAS_B0200.bit.bin`.
...
`bitstreams/BOOT_B0200_v0.15.448.BIN` in those few bytes unless the input is named the same. Built from
...
The navigator's top line shows the firmware and the core build, for example `v0.15.448 / b0200`.
The same core number is readable at control-plane register `0x00` (`0xB01B0200`).
