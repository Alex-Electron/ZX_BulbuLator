# MUST-PASS ФИКСТУРЫ — манифест (claude-mon, 2026-07-21)

Недостающие форматные фикстуры для must-pass матрицы (WAV s16 + 48к; MP3 CBR/VBR).
Собраны **off-board**, детерминированно. Стейдж для GPT: `thinkpad:/tmp/fixtures/{wav,mp3}` (SHA сверены после rsync).
