...
# The initial APB target can be stale after a prior PCAP/reset cycle.  Reset via
# the DAP fallback, then wait until the Cortex-A9 targets are enumerated again.
