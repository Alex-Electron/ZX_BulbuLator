# Bulbulator Step 9 - Step 8 + a real PS/2 keyboard (mux into the Atlas core), xc7z010clg400-1.
#
...
#
# This step's only RTL change vs Step 8 is the top (PS/2 mux + reset/hotkey wiring)
# and its constraints; everything else - core, glue, DDR chain - is the Step 8 set,
# gathered by assemble.sh. The file list below is therefore identical to Step 8's.
...
# EBAZ glue + control plane + DDR-framebuffer chain + the PS/2 top.
read_verilog [list clock_zx.v mem_zx.v kbd_buttons.v \
  axi_ctl.v inject_cdc.v \
  fb_capture_rr.v async_fifo.v fb_wr_axi.v fb_bufmgr3.v fb_loader.v fb_display.v \
