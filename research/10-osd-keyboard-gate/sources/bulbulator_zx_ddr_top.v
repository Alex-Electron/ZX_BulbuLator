...
(
    ...
    axi_ctl #(.VERSION(32'hB01B0006)) ctl (
        ...
        .ctl_osd_waddr(ctl_osd_waddr), .ctl_osd_wdata(ctl_osd_wdata),
    ...
    osd_compositor osd_i (
        ...
        .osd_waddr(ctl_osd_waddr), .osd_wdata(ctl_osd_wdata),
