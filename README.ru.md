...
**Машины.** ZX Spectrum 48K, 128K и Пентагон 1024 на одном ядре; ядро MiSTer-48 — отдельным битстримом
как сверочная нога; NES/Денди — вторая платформа, своим ядром. Две синклеровские машины сверены
измерением, а не на глаз: их наборы тестов таймингов проходят целиком. У Пентагона работают и
...
**Лента.** `.tap`, `.tzx`, `.wav` и `.mp3`, с мгновенной загрузкой через ловушку в ПЗУ и разгоном до 8×.
