...
**Машины.** ZX Spectrum 48K, 128K и Пентагон 1024 на одном ядре, и каждая сверена с настоящей машиной
измерением, а не на глаз (Шаг 15); NES/Денди — вторая платформа, своим ядром.
...
ЦАП, играющий музыку**. Выход через I²S и аудио HDMI, с пик-метром по источникам: тишина сама по себе
...
решение, принятое за тебя; порт `#FF` у Пентагона — постоянный пример.
