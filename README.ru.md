...
|---|---|---|
| `bitstreams/BOOT_B0198_v0.15.446.BIN` | `BOOT.BIN` | загрузочный образ: начальный загрузчик, ядро ZX и прошивка оболочки |
| `bitstreams/ATLAS_B0198.bit.bin` | `CORES/ATLAS.BIT.BIN` | ядро ZX; оболочка перезагружает его отсюда при смене машины |
...
- **Сеть** ([Шаг 16](https://github.com/Alex-Electron/ZX_BulbuLator/issues/82)) — веб-пульт с живым экраном, клавиатурой и файловым
...
- **Ещё машины** — сначала C64, потом ATM Turbo.
